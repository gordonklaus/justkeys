module Voronoi.Geometry.Edge exposing (..)
...
import Voronoi.Model exposing (Edge, Triangle)
...
averageColor edge =
    let
        a =
            Color.toRgb (Color.rgb 255 0 0)

        b =
            Color.toRgb (Color.rgb 0 0 255)
    in
    Voronoi.ColorHelper.colorToHex
        (Color.rgb
