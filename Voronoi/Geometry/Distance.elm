module Voronoi.Geometry.Distance exposing (..)

import Math.Vector2 exposing (Vec2, getX, getY, vec2)
import Voronoi.Model exposing (Distance, Point)


distance : Distance -> Vec2 -> Vec2 -> Float
distance distForm a b =
    case distForm of
        Voronoi.Model.Euclidean ->
            distanceEuclidean a b

        Voronoi.Model.Manhattan ->
            distanceManhattan a b

        Voronoi.Model.Chebyshev ->
